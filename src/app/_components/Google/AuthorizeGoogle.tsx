...
export default function AuthorizeGoogle() {
  ...
  const { isLoading: isAuthenticatedLoading, data: isAuthenticated } = api.google.isAuthenticated.useQuery()
  ...
  return <button className="hover:underline" onClick={() => window.open(authUrl, "_blank")}>Authorize Myncer For Google</button>
}
